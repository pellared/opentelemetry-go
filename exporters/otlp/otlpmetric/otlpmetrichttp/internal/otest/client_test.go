...
func (*client) Temporality(k metric.InstrumentKind) metricdata.Temporality {
	return metric.DefaultTemporalitySelector(k)
}

func (*client) Aggregation(k metric.InstrumentKind) metric.Aggregation {
...
func (*client) ForceFlush(ctx context.Context) error { return ctx.Err() }
func (*client) Shutdown(ctx context.Context) error   { return ctx.Err() }
